...
Professional position management and risk control recommendation system. For detailed risk management methodology, see `risk-management.md`.
...
Based on user's total capital and risk preference (see `risk-management.md`):
